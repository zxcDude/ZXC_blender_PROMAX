package com.com.сgvsu.objreader;

import com.com.сgvsu.math.Point2f;
import com.com.сgvsu.math.Vector3f;
import com.com.сgvsu.model.Model;
import com.com.сgvsu.model.Polygon;
...
public class ObjReader {
    ...
    protected static Point2f parseTextureVertex(final ArrayList<String> wordsInLineWithoutToken, int lineInd) {
        try {
            return new Point2f(
                    Float.parseFloat(wordsInLineWithoutToken.get(0)),
                    Float.parseFloat(wordsInLineWithoutToken.get(1)));
